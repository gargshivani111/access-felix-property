...
new hobs.TestSuite("CQ_Bootcamp Tests", {path:"/apps/cq-bootcampl/tests/SampleTests.js", register: true})
    ...
    .addTestCase(new hobs.TestCase("Navigate to english page")
        .navigateTo("/content/cq-bootcamp/en.html")
        .asserts.location("/content/cq-bootcamp/en.html", true)
        .asserts.visible(".servicecomponent", true)
    )

    .addTestCase(new hobs.TestCase("Navigate to french page")
        .navigateTo("/content/cq-bootcamp/fr.html")
        .asserts.location("/content/cq-bootcamp/fr.html", true)
        .asserts.visible(".servicecomponent", true)
    );
